            ...
            public void onItemClick(ArrayList<RealmSeller> realmSellers, int position, SellerIndexAdapter.ViewHolder holder) {
                ...
                StringRequest stringRequest = new StringRequest(
                    ...
                    public Map getHeaders() throws AuthFailureError {
                        ...
                        headers.put("Authorization", "Bearer " + PreferenceManager.getDefaultSharedPreferences(sellerIndexActivity).getString(APITOKEN, ""));
                        return headers;
                    }
                };
                    ...
                    if (item.getItemId() == R.id.edit) {
                        StringRequest stringRequest = new StringRequest(
                            ...
                            public Map getHeaders() throws AuthFailureError {
                                HashMap headers = new HashMap();
                                headers.put("accept", "application/json");
                                headers.put("Authorization", "Bearer " + PreferenceManager.getDefaultSharedPreferences(getApplicationContext()).getString(HomeActivity.APITOKEN, ""));
                                return headers;
                            }
                        };
                        stringRequest.setRetryPolicy(new DefaultRetryPolicy(
