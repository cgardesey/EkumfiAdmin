...
import com.ekumfi.admin.fragment.ConsumerAccountFragment1;
import com.ekumfi.admin.other.MyHttpEntity;
import com.ekumfi.admin.pagerAdapter.ConsumerAccountPageAdapter;
...
public class ConsumerAccountActivity extends PermisoActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getStringExtra("MODE").equals("EDIT")) {
            ...
            realmConsumer = Realm.getInstance(RealmUtility.getDefaultConfig(ConsumerAccountActivity.this)).where(RealmConsumer.class).equalTo("consumer_id", PreferenceManager.getDefaultSharedPreferences(ConsumerAccountActivity.this).getString("CONSUMERID", "")).findFirst();
...
//                multipartEntityBuilder.addTextBody("auxiliary_contact", ConsumerAccountFragment1.auxiliarycontact.getText().toString());
                ...
                multipartEntityBuilder.addTextBody("user_id", PreferenceManager.getDefaultSharedPreferences(getApplicationContext()).getString(MYUSERID, ""));
