...
import com.ekumfi.admin.adapter.SellerIndexAdapter;
                    ...
                    if (itemId == R.id.edit) {
                        ...
                        StringRequest stringRequest = new StringRequest(
                            ...
                            public Map getHeaders() throws AuthFailureError {
                                ...
                                headers.put("Authorization", "Bearer " + PreferenceManager.getDefaultSharedPreferences(SellerIndexActivity.this).getString(HomeActivity.APITOKEN, ""));
                                return headers;
                            }
                        };
...
//                                                    realm.where(RealmSellerProduct.class).findAll().deleteAllFromRealm();
                            ...
                            public Map getHeaders() throws AuthFailureError {
                                HashMap headers = new HashMap();
                                headers.put("accept", "application/json");
                                headers.put("Authorization", "Bearer " + PreferenceManager.getDefaultSharedPreferences(SellerIndexActivity.this).getString(APITOKEN, ""));
                                return headers;
                            }
