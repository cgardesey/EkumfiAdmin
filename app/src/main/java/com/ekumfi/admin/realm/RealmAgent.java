package com.ekumfi.admin.realm;
...
public class RealmAgent extends RealmObject {
    ...
    public RealmAgent(int id, String agent_id, String confirmation_token, String name, String profile_image_url, String primary_contact, String auxiliary_contact, double longitude, double latitude, double live_longitude, double live_latitude, String digital_address, String street_address, String availability, int verified, String user_id, String created_at, String updated_at, RealmUser user) {
        this.id = id;
