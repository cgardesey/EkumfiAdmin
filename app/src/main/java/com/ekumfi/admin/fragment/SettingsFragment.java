...
import static com.ekumfi.admin.constants.keyConst.GUID_WS_URL;
...
import static com.ekumfi.admin.util.Socket.EVENT_CLOSED;
import static com.ekumfi.admin.util.Socket.EVENT_OPEN;
import static com.ekumfi.admin.util.Socket.EVENT_RECONNECT_ATTEMPT;
...
import com.ekumfi.admin.activity.AgentIndexActivity;
import com.ekumfi.admin.activity.HelpActivity;
import com.ekumfi.admin.activity.MapsActivity;
import com.ekumfi.admin.activity.AccountActivity;
import com.ekumfi.admin.R;
import com.ekumfi.admin.activity.SellerIndexActivity;
import com.ekumfi.admin.activity.SigninActivity;
import com.ekumfi.admin.activity.StockPaymentActivity;
import com.ekumfi.admin.activity.StockOrdersActivity;
import com.ekumfi.admin.activity.WholesalerIndexActivity;
import com.ekumfi.admin.other.InitApplication;
import com.ekumfi.admin.realm.RealmCustomer2;
import com.ekumfi.admin.realm.RealmEkumfiInfo;
import com.ekumfi.admin.realm.RealmSeller;
import com.ekumfi.admin.util.RealmUtility;
import com.ekumfi.admin.util.Socket;
...
public class SettingsFragment extends Fragment {
    ...
    CardView conferencecallno, paymentsbtn, profilebtn, displaybtn, availabilitybtn, logout, faqs, webportal, consumer_orders, stock_orders, vendors, agents, wholesalers;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        wholesalers = rootView.findViewById(R.id.wholesalers);
        ...
        wholesalers.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getActivity(), WholesalerIndexActivity.class));
            }
        });
        ...
        availabilitybtn.setOnClickListener(view -> {
            clickview(view);
            Realm.init(getContext());
            String availability = Realm.getInstance(RealmUtility.getDefaultConfig(getContext())).where(RealmEkumfiInfo.class).findFirst().getAvailability();
        ...
        availabilityswitch.setOnToggleChanged(new TriStateToggleButton.OnToggleChanged() {
            ...
            public void onToggle(TriStateToggleButton.ToggleStatus toggleStatus, boolean booleanToggleStatus, int toggleIntValue) {
                Realm.init(getContext());
                RealmEkumfiInfo realmEkumfiInfo = Realm.getInstance(RealmUtility.getDefaultConfig(getContext())).where(RealmEkumfiInfo.class).findFirst();
                String ekumfi_info_id = realmEkumfiInfo.getEkumfi_info_id();
                ...
                StringRequest stringRequest = new StringRequest(
                        Request.Method.POST,
                        API_URL + "ekumfi-infos/" + ekumfi_info_id,
                        response -> {
                            dialog.dismiss();
                            if (response != null) {
                                ...
                                Realm.getInstance(RealmUtility.getDefaultConfig(activeActivity)).executeTransaction(realm -> {
                                    realm.createOrUpdateObjectFromJson(RealmEkumfiInfo.class, finalJsonObjectResponse);
                                });
                                ...
                                try {
                                    JSONObject jsonObject = new JSONObject()
                                            .put("ekumfi_info_id", ekumfi_info_id);
                    ...
                    public Map getHeaders() throws AuthFailureError {
                        ...
                        headers.put("Authorization", "Bearer " + PreferenceManager.getDefaultSharedPreferences(activeActivity).getString(APITOKEN, ""));
                        return headers;
                    }
                };
                ;
    ...
    public void initChatSocket() {
        ...
        chatSocket.onEvent(EVENT_OPEN, new Socket.OnEventListener() {
            ...
            public void onMessage(String event) {
                ...
                StringRequest stringRequest = new StringRequest(
                        Request.Method.GET,
                        API_URL + "ekumi-infos/" + ekumfi_info_id,
                        response -> {
                            if (response != null) {
                                try {
