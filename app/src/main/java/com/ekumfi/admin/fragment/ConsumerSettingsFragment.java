...
import com.ekumfi.admin.activity.ConsumerOrdersActivity;
import com.ekumfi.admin.activity.ConsumerPaymentActivity;
import com.ekumfi.admin.activity.SelectRoleActivity;
import com.ekumfi.admin.R;
import com.ekumfi.admin.activity.ConsumerAccountActivity;
...
public class ConsumerSettingsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        /*availabilitybtn.setOnClickListener(view -> {
            ...
            String availability = Realm.getInstance(RealmUtility.getDefaultConfig(getContext())).where(RealmConsumer.class).equalTo("consumer_id", PreferenceManager.getDefaultSharedPreferences(getContext()).getString("CONSUMERID", "")).findFirst().getAvailability();
        ...
        availabilityswitch.setOnToggleChanged(new TriStateToggleButton.OnToggleChanged() {
            ...
            public void onToggle(TriStateToggleButton.ToggleStatus toggleStatus, boolean booleanToggleStatus, int toggleIntValue) {
                Realm.init(getContext());
                RealmConsumer realmConsumer = Realm.getInstance(RealmUtility.getDefaultConfig(getContext())).where(RealmConsumer.class).equalTo("consumer_id", PreferenceManager.getDefaultSharedPreferences(getContext()).getString("CONSUMERID", "")).findFirst();
